...
class Affichage:
    ...
    def Processus2(self, fenetre, largeur, hauteur):
        ...
        ProcessSep1 = tk.Label(fenetre)
        ProcessSep1["bg"] = "#4C687A"
        ProcessSep1.place(x=screenwidth/2+125,y=hauteur/9+150,width=10,height=550)

        ProcessSep2 = tk.Label(fenetre)
        ProcessSep2["bg"] = "#4C687A"
        ProcessSep2.place(x=screenwidth/2+635,y=hauteur/9+150,width=10,height=550)
...
#aff = Affichage()
#aff.accueil(fenetre, screenwidth, screenheight)
